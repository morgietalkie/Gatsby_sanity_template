...
// Import icons
(0, _storybook.storiesOf)('Tabs', module).addDecorator(_knobs.withKnobs).add('Default', () => {
  ...
  }, _react.default.createElement(_tabList.default, null, tabs.map(tab => _react.default.createElement(_tab.default, {
