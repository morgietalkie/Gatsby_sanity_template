...
function ActionStateDialog(props) {
  ...
  if (dialog.type === 'legacy') {
    return React.createElement(React.Fragment, null, dialog.content);
  }
  ...
  if (dialog.type === 'confirm') {
    ...
    }, dialog.message), React.createElement(_buttonGrid.default, null, React.createElement(_default2.default, {
      onClick: dialog.onCancel,
      kind: "simple"
    }, "Cancel"), React.createElement(_default2.default, {
  ...
  if (dialog.type === 'success') {
    return React.createElement(_default3.default, {
      kind: "success",
      isPersisted: false,
      isCloseable: true,
      timeout: 2000,
