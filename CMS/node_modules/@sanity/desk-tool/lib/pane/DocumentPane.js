...
class DocumentPane extends _react.default.PureComponent {
  constructor(props, _context) {
    ...
    _defineProperty(this, "renderActions", () => {
      ...
      }, _languageSelectComponent.default && _react.default.createElement(_languageSelectComponent.default, null), _react.default.createElement(_Validation.Validation, {
        id: options.id,
        type: options.type,
        markers: markers,
    ...
    _defineProperty(this, "renderHistoryFooter", selectedEvent => {
      ...
      return _react.default.createElement(_DocumentStatusBar.HistoryStatusBar, {
        id: options.id,
        type: options.type,
    ...
    _defineProperty(this, "renderFooter", () => {
      ...
      return _react.default.createElement(_DocumentStatusBar.DocumentStatusBar, {
        id: options.id,
        type: options.type,
  ...
  renderError(error) {
    return _react.default.createElement("div", {
      ...
      return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_default.default, {
        onClick: () => this.setup(this.props.options.id)
      }, "Reload"), _react.default.createElement(_default.default, {
        inverted: true,
  ...
  renderUnknownSchemaType() {
    ...
    }, _react.default.createElement("h3", null, "Unknown schema type"), typeName && _react.default.createElement("p", null, "This document has the schema type ", _react.default.createElement("code", null, typeName), ", which is not defined as a type in the local content studio schema."), !typeName && _react.default.createElement("p", null, "This document does not exist, and no schema type was specified for it."), __DEV__ && value && _react.default.createElement("div", null, _react.default.createElement("h4", null, "Here is the JSON representation of the document:"), _react.default.createElement("pre", null, _react.default.createElement("code", null, JSON.stringify(value, null, 2))))));
  }
  ...
  render() {
    ...
    return _react.default.createElement(_DocumentActionShortcuts.DocumentActionShortcuts, {
      id: options.id,
      type: typeName,
      ...
      value: value,
      onClose: this.handleHideInspector
    }), connectionState === 'reconnecting' && _react.default.createElement(_default2.default, {
      kind: "warning",
      isPersisted: true,
      title: "Connection lost. Reconnecting\u2026"
    }), _react.default.createElement(_DocumentOperationResults.DocumentOperationResults, {
      id: options.id,
      type: options.type
    })));
  }
