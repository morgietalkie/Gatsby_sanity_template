...
function () {
  var _deleteApiAction = _asyncToGenerator(function* (args, context) {
    ...
    var confirmMessage = tag === 'default' ? "Are you absolutely sure you want to delete the current GraphQL API connected to the \"".concat(dataset, "\" dataset?") : "Are you absolutely sure you want to delete the GraphQL API connected to the \"".concat(dataset, "\" dataset, tagged \"").concat(tag, "\"?");
